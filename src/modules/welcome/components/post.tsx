        ...
        <div className="flex flex-col pb-0.5">
            ...
            <div className="mt-2 border border-dark-300 rounded-lg bg-dark-800 p-3">
                ...
                <button
                    ...
                    className={cn(
                        "group h-8 w-full flex items-center justify-center border border-dark-200 rounded-lg bg-dark-300/50 px-2 text-center text-sm transition active:(bg-dark-400) hover:(bg-dark-300)",
